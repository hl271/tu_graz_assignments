...
#include <path_planner/path_planner_ros.h>
...
void DLA2PathPlanner::plan()
{
    ...
    std::string path = ros::package::getPath("dla4_final_demo");        
    std::cout << path << "/maps/dronespace_synthetic.bt \n";
    tree->readBinary(path+"/maps/dronespace_synthetic.bt");
